...
func main() {
	...
	var installFlag = flag.Bool("install", false, "Install Penguincord")
	var updateFlag = flag.Bool("repair", false, "Repair Penguincord")
	var uninstallFlag = flag.Bool("uninstall", false, "Uninstall Penguincord")
	...
	if *versionFlag {
		...
		fmt.Println("Copyright (C) 2026 Vendicated, thororen1234, Vencord, and Equicord and Penguincord contributors")
	...
	if install {
		...
		Log.Info("Downloading latest Penguincord files...")
...
func HandleScuffedInstall() {
	...
	fmt.Println("Otherwise, Penguincord will likely not work.")
}
